...
<div class="container mx-auto px-4 py-6">
    <div class="max-w-2xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="<?php echo e(route('products.index')); ?>" class="bg-gray-500 text-white px-4 py-2 rounded hover:bg-gray-600">
                Back to List
            </a>
        </div>
        ...
        <form action="<?php echo e(route('products.store')); ?>" method="POST" class="space-y-6" id="productForm">
            <?php echo csrf_field(); ?>
            <div class="bg-white rounded-lg shadow p-6 space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="3" 
                              class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200"><?php echo e(old('description')); ?></textarea>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="date" name="expiry_date" id="expiry_date" value="<?php echo e(old('expiry_date')); ?>"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" step="0.01" name="price" id="price" value="<?php echo e(old('price')); ?>"
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200" required>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="status" id="status" 
                            ...
                            <option value="for_approval" <?php echo e(old('status') == 'for_approval' ? 'selected' : ''); ?>>For Approval</option>
                ...
                <div>
                    ...
                    <textarea name="notes" id="notes" rows="2" 
                              class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200"><?php echo e(old('notes')); ?></textarea>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function createRequirementFields() {
        ...
        requirementDiv.innerHTML = `
            <div class="grid grid-cols-12 gap-4">
                <div class="col-span-6">
                    ...
                    <select class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 requirement-type" required>
                        ...
                        ${availableTypes.map(type => 
                            `<option value="${type}">${requirementConfig[type].label}</option>`
                        ).join('')}
                    </select>
                </div>
                <div class="col-span-6">
                ...
                <div class="col-span-6">
                    ...
                    <input type="number" step="0.1" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 requirement-min" required>
                </div>
                <div class="col-span-6">
                    <label class="block text-sm font-medium text-gray-700">Max</label>
                    <input type="number" step="0.1" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 requirement-max" required>
                </div>
            </div>
        `;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/pharma-api/resources/views/products/create.blade.php ENDPATH**/ ?>