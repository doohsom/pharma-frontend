...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8 bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg shadow-lg p-6 text-white">
        ...
        <p class="text-xl mt-2">Welcome back, <?php echo e(Auth::user()->name); ?> (<?php echo e(Auth::user()->role); ?>)</p>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/pharma-api/resources/views/dashboard.blade.php ENDPATH**/ ?>