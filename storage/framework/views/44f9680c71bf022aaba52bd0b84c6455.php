    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden">
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr>
                    <td class="px-6 py-4"><?php echo e($batch['id']); ?></td>
                    <td class="px-6 py-4"><?php echo e($batch['product']['name']); ?></td>
                    <td class="px-6 py-4"><?php echo e($batch['order']['quantity']); ?></td>
                    <td class="px-6 py-4">
                        <span class="px-2 py-1 text-sm rounded-full 
                            <?php echo e($batch['status'] === 'created' ? 'bg-blue-100 text-blue-800' : 
                    ...
                    <td class="px-6 py-4"><?php echo e(date('Y-m-d', strtotime($batch['createdAt']))); ?></td>
                    <td class="px-6 py-4">
                        <div class="flex space-x-2">
                            <button onclick="openDetailsModal('<?php echo e($batch['id']); ?>')" 
                            ...
                            <button onclick="openStatusModal('<?php echo e($batch['id']); ?>')" 
                            ...
                            <?php if($batch['status'] === 'created'): ?>
                            <button onclick="openSensorModal('<?php echo e($batch['id']); ?>')" 
                            ...
                            <button onclick="openSensorsModal('<?php echo e($batch['id']); ?>')" 
                            ...
                            <?php endif; ?>
                            <?php if($batch['status'] === 'in_transit'): ?>
                            <a href="/batches/<?php echo e($batch['id']); ?>/dashboard" 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/pharma-api/resources/views/batch/index.blade.php ENDPATH**/ ?>