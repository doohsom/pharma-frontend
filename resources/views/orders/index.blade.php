        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4">
                        <span class="px-2 py-1 text-sm rounded-full {{ $order['status'] }}">
                    ...
                    <td class="px-6 py-4 space-x-2">
                        ...
                        <button onclick="openDetailsModal('{{ $order['id'] }}')" 
                        ...
                        @if(Auth::user()->role === 'manufacturer')
                            @if(in_array($orderStatus, ['pending', 'processed']))
                                <button onclick="openDetailsModal('{{ $order['id'] }}')" 
                            ...
                            <a href="{{ route('batches.create', $order['id']) }}" 
                        ...
                        @if(Auth::user()->role === 'logistics')
                            @if(in_array($orderStatus, ['to_be_batched', 'in_transit']))
                                <button onclick="openDetailsModal('{{ $order['id'] }}')" 
                        ...
                        <!-- Vendor Actions -->
                        @if(Auth::user()->role === 'vendor' && $orderStatus === 'pending')
                            <button onclick="openDetailsModal('{{ $order['id'] }}')" 
